...
execute if data storage madv:gr {load_message: 1b} run tellraw @a [{"text": "[More Advencements Plus] "}, {"fallback": "更多进度数据包（扩展）Alpha Replacing Elementarily版本加载完成！", "translate": "messages.madv_plus.load", "color": "yellow"}]
