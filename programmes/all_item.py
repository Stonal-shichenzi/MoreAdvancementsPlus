# 这一堆注释是创建一个写有所有MC中方块&物品的文件
# import json

# # 从zh_cn.json中复制全部ISON文件到6个双引号之间，这里省略
# vanilla_language_json_file = r"""
# """
# vanilla_language_json: dict = json.loads(vanilla_language_json_file)
# # 写入F:\minecraft_items\26.1.txt文件
# writing = open("F:/minecraft_items/26.1.txt", mode="w", encoding="utf-8")
# for i in vanilla_language_json.keys():
#     if len(i) > 16:
#         # 防止报错
#         if i[0:16] == "block.minecraft.":
#             if "." not in i[16:]:
#                 writing.write(i[16:] + "\n")
#             continue
#     if len(i) > 15:
#         # 防止报错
#         if i[0:15] == "item.minecraft.":
#             if "." not in i[15:]:
#                 writing.write(i[15:] + "\n")
#             continue
...
all_items_that_are_allowed_to_acquire = """acacia_button
acacia_door
acacia_fence
acacia_fence_gate
acacia_hanging_sign
...
display["title"] = translation("物品全收集")
display["description"] = translation("集齐所有物品", False)

for i in all_items_that_are_allowed_to_acquire_array:
    criteria[i] = dict()
    criteria[i]["trigger"] = "minecraft:inventory_changed"
    criteria[i]["conditions"] = dict()
